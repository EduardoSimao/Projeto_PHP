...
<span class="login100-form-title p-b-37">
        ...
        <form class="login100-form validate-form" method="post" action="/cantor/{{$cantor->id}}">
        @csrf
    @method("put")

    <div class="wrap-input100 validate-input m-b-20" data-validate="Nome">
      <input class="input100" type="text" name="nome" placeholder="Nome" value="{{$cantor->nome}}" require>
