...
@extends('master')
@section('titulo','Editar Musica')
@section('conteudo')
<div class="container-login100">
<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
<span class="login100-form-title p-b-37">Menu</span>
  ...
  <form class="login100-form validate-form" method="post" action="/musica/{{$musica->id}}">
    @csrf
    @method("put")
    <div class="wrap-input100 validate-input m-b-20" data-validate="Nome">
      <input class="input100" type="text" name="nome" placeholder="Nome" value="{{$musica->nome}}" require>
      <span class="focus-input100"></span>
    </div>
    <div class="select input100 focusspan">
      <select name="genero_id" id="slct">
