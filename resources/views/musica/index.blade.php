...
<span class="login100-form-title p-b-37">
  ...
  <div class="text-center cantores">
    ...
    <span>{{$a->nome}}</span>
    <span class="albuns">{{$a->genero_id}}</span>
    <span class="albuns">{{$a->albuns_id}}</span>
    <span class="spancantor"><a class="cant" href="musica/{{$a->id}}/edit">Editar</a></span>
	<br>
    @endforeach
  </div>
  <div class="text-center rod">
    <a class="txt2 hov1 cant" href="/musica/create">Novo Musica</a>
  </div>
</div>
@endsection