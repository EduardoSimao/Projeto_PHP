...
<span class="login100-form-title p-b-37">
        ...
        <span class="centerspan">Editar Genero</span>
        <form class="login100-form validate-form" method="post" action="/genero/{{$genero->id}}">
        @csrf
    @method("put")

    <div class="wrap-input100 validate-input m-b-20" data-validate="Nome">
      <input class="input100" type="text" name="genero" placeholder="Nome" value="{{$genero->genero}}" require>
