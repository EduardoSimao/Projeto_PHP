...
<span class="login100-form-title p-b-37">
        ...
        <div class="text-center">
          ...
          <a class="menudados active" href="/genero">Generos</a>
          <a class="menudados" href="/album">Albuns</a>
          <a class="menudados" href="/musica">Musicas</a>
        </div>
        <span class="centerspan">Novo Gênero</span>
        <form class="login100-form validate-form" method="post" action="/genero">
        @csrf

    <div class="wrap-input100 validate-input m-b-20" data-validate="Nome">
      <input class="input100" type="text"  name="genero" placeholder="Nome" require>
